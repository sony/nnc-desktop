    ...
    <div id="dataset-container" :class="!isLocalTenant() ? 'share-tenant' : ''">
      ...
      <div class="dataset-menu-height border-bottom dataset-action">
        <div class="box box-align-center action-menu-area">
          ...
          <!--nncd: add v-if-->
          <div v-if="this.isShowInLocalEditor" class="box box-align-center action-menu upload-dataset-browser">
            <img src="/console/image/upload.svg" alt="Upload">
            <div class="action-menu-string">
          ...
          <create-dataset 
            ...
            :setPollingForDataset="setPollingForDataset"
          />
          <div id="copy-area" @click.stop v-if="shouldShowCopyArea && this.isShowInLocalEditor">
          <!-------->
        ...
        <div class="action-menu-area-filter-and-search" id="dataset">
          ...
          <!--nncd: add v-if-->
          <div id="workspace-info-area" class="box box-align-center" v-if="this.isShowInLocalEditor" >
